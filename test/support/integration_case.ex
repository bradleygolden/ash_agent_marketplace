defmodule AshAgentMarketplace.IntegrationCase do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule AshAgentMarketplace.Integration.ReqLLM.OpenAI.MetadataTest do
      ...
      defmodule AshAgentMarketplace.Integration.Ollama.StreamingTest do
        use AshAgentMarketplace.IntegrationCase, provider: :ollama
